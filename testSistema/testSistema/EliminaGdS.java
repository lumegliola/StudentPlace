...
public class EliminaGdS {
	...
	@Test
	public void testEliminaGdS() throws Exception {
		...
		driver.findElement(By.linkText("Antonio")).click();
		driver.findElement(By.name("cancella_gruppo")).click();
	}
