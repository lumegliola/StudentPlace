...
public class AulaLiberaDAOimplTest {
	...
	public void testDoRetrieveAll() {
		...
		//lista risultati
		List<AulaLibera> listaRisultati = DAOFactory.getAulaLiberaDAO().doRetrieveAll();
		
		//genero la lista oracolo(cerco per una data precendete a tutto)
		List<AulaLibera> listaOracolo = DAOFactory.getAulaLiberaDAO().doRetrieveByDate(inizio);
		System.out.println("successo");
