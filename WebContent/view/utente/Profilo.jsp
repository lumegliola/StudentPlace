...
<body>
	...
	<div style="min-height: 30em; margin-top: 15px;">
		...
		<!----------------------- Gruppi dell'utente ----------------------->
			...
			<div id=group_container class="container-fluid">
			<div class="col-lg-8">
				<h4>I tuoi gruppi</h4>
				...
				%>
					...
					<tr>
						...
						<td><%=p.getOrario().getInizio().toGMTString().substring(0, 21)%> fino alle: <%=p.getOrario().getFine().toString().substring(11, 19)%></td>
					</tr>
		...
		<div class="row">
				...
				<tr>
					...
					<td><%=p.getMateria()%></td>
					<td>Edificio: <%=p.getAula().getEdificio()%>,Aula: <%=p.getAula().getNomeAula()%></td>
					<td><%=p.getOrario().getInizio().toString().substring(0, 10)%> dalle: <%=p.getOrario().getInizio().toString().substring(10, 16)%></td>
				</tr>
	...
	<div class="col-lg-4" style="border-left: 1px solid red;">
		<table>
			<tr>
				<th style="text-align: center"><img alt="avatar" src="view/images/avatar.jpg"></th>
			</tr>
			<tr>
				<td><h4><%=completo.getNome()%>
						<%=completo.getCognome()%></h4></td>
			</tr>
			<tr>
